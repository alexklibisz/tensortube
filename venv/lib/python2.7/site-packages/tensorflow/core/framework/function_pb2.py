...
_FUNCTIONDEF = _descriptor.Descriptor(
  ...
  nested_types=[_FUNCTIONDEF_NODE, _FUNCTIONDEF_RETENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
